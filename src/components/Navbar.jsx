        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between md:grid md:grid-cols-3">
          ...
          <div className="hidden md:flex items-center gap-3 justify-end">
            {mounted && isAdmin && (
              <button
                onClick={toggleTheme}
                className="flex h-9 w-9 items-center justify-center rounded-full border-0 bg-[#facc15] text-white shadow-sm transition-all duration-200 hover:bg-[#fbbf24]"
              ...
              >
                {theme === "dark" ? (
                  ...
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M21 14.2A8 8 0 0 1 9.8 3 9 9 0 1 0 21 14.2Z" />
                  </svg>
                )}
              </button>
            )}
            ...
            {user ? (
              isAdmin ? (
                ...
                >
                  <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-[#ff3445] text-sm font-bold text-white">
                  ...
                  <div className="min-w-[76px]">
                    ...
                    <div className="mt-0.5 text-[11px] leading-none text-white/55">
                      Admin
                    </div>
                  </div>
                  <Link
                    href="/admin"
                    className="rounded-md bg-[#facc15] px-4 py-1.5 text-sm font-bold text-[#4a3400] transition-colors hover:bg-[#fbbf24]"
                  >
                    Dashboard
                  </Link>
                  <button
